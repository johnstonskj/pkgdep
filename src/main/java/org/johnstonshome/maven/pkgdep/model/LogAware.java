...
/**
 * This interface simply marks a class as requiring a {@link Log} instance
 * and is generally used to pass a log from a goal into model classes.  
 * 
...
public interface LogAware {
	 ...
	 * 
	 * @param log an instance of {@link Log}.
	 */
